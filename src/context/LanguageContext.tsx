...
const translations = {
  EN: {
    ...
    'contact.submit.success': 'Thank you! Your message has been sent.',
    'contact.submit.error': 'Sorry, your message could not be sent. Please try again.',
    'contact.hq.title': 'Headquarters',
    'contact.follow.instagram': 'Follow us on Instagram',
  ...
  FR: {
    ...
    'contact.submit.sending': 'Envoi...',
    'contact.submit.success': 'Merci ! Votre message a été envoyé.',
    'contact.submit.error': "Désolé, votre message n'a pas pu être envoyé. Veuillez réessayer.",
    'contact.hq.title': 'Siège Social',
    'contact.follow.instagram': 'Suivez-nous sur Instagram',
    'contact.follow.facebook': 'Suivez-nous sur Facebook',
  ...
  AR: {
    ...
    'contact.submit.sending': 'جارٍ الإرسال...',
    'contact.submit.success': 'شكراً لك! تم إرسال رسالتك.',
    'contact.submit.error': 'عذراً، تعذر إرسال رسالتك. يرجى المحاولة مرة أخرى.',
    'contact.hq.title': 'المقر الرئيسي',
    'contact.follow.instagram': 'تابعنا على إنستغرام',
    'contact.follow.facebook': 'تابعنا على فيسبوك',
