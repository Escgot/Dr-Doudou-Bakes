  ...
  const categories = [
    {
      ...
      title: 'SINGLE-SERVE',
      description: 'Our chef-crafted snacks and mini desserts deliver exceptional flavor and shelf appeal in a single-serving size.',
    },
    {
      image: '/images/desserts/prepackaged.jpg',
      title: 'PREPACKAGED',
      description: 'Retail-ready classic bakery items in convenient packaging, perfectly portioned, and available in a range of sizes.',
    },
    {
      image: '/images/desserts/seasonal-pie.jpg',
      title: 'SEASONAL & NEW',
      description: 'Explore desserts with standout appeal that drive relevance all year.',
    },
    {
      image: '/images/desserts/premium-cake.jpg',
      title: 'PREMIUM CAKES',
      description: 'Visually stunning, scratch-made multi-layer bar cakes, round cakes, molten, and gluten-free cakes crafted to perfection.',
    },
    {
      image: '/images/desserts/cheesecake.jpg',
      title: 'PREMIUM CHEESECAKES',
      description: 'An impressive assortment of smooth & creamy cheesecakes made with real cream cheese and fresh ingredients.',
    },
    {
      image: '/images/desserts/brownies.jpg',
      title: 'BROWNIES & BARS',
      description: 'A premium collection of dessert bars and brownies with our signature layering capabilities, ideal for on-the-go formats.',
    },
    {
      image: '/images/desserts/cake-slice.jpg',
      title: 'PREMIUM PIES',
      description: 'Classic and innovative pie varieties made with premium fillings and flaky, buttery crusts.',
    },
    {
      image: '/images/desserts/chocolate-roll.jpg',
      title: 'GLUTEN-FREE',
      description: 'Delicious gluten-free options that never compromise on taste or texture.',
    },
    {
      image: '/images/desserts/honey-cake.jpg', // You will need to add this image
      title: 'HONEY CAKES',
      description: 'Traditional honey-infused layers creating a rich, deeply comforting flavor profile.',
    },
    {
      image: '/images/desserts/macarons.jpg', // You will need to add this image
      title: 'FRENCH MACARONS',
      description: 'Delicate, airy almond shells filled with an assortment of velvety ganaches and preserves.',
    },
    {
      image: '/images/desserts/fruit-tart.jpg', // You will need to add this image
      title: 'FRUIT TARTS',
      description: 'Crisp pastry shells overflowing with vanilla custard and beautifully arranged seasonal fruits.',
    },
    {
      image: '/images/desserts/chocolate-truffles.jpg', // You will need to add this image
      title: 'ARTISAN TRUFFLES',
      description: 'Hand-rolled chocolate ganache coated in premium cocoa dust and toasted nuts.',
    },
  ];
