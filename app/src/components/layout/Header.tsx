      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center py-4">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            />
            <span className="text-white font-brand text-2xl tracking-wide">
              Dr Doudou Bakes
            </span>
          </Link>
        </div>
          ...
          <div className="hidden lg:flex items-center justify-center py-4 relative">
            ...
            {navItems.map((item) => (
              <li key={item.label}>
                <Link
                  to={item.href}
                  className={`text-white text-xs font-medium tracking-widest hover:opacity-80 transition-opacity duration-200 ${
